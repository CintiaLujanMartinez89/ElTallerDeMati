        ...
        <div class="container">
            <section class="intro">
                ...
                <div class="gv-container">
                    <asp:GridView ID="gvMisMotos" CssClass="auto-style1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" Height="183px" Width="682px" OnRowDeleting="gvMisMotos_RowDeleting">
            ...
            <section class="intro">
                ...
                <br />
                <div class="gv-container">
                    <asp:GridView ID="gvMisTurnos" CssClass="auto-style1" runat="server" AutoGenerateDeleteButton="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="183px" Width="683px" OnRowDeleting="gvMisTurnos_RowDeleting">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField HeaderText=" Patente">
                                <ItemTemplate>
