...
<body>
    ...
    <SortedDescendingHeaderStyle BackColor="#4870BE" />
            ...
            <section class="intro">
                ...
                <div class="container">
                <div class="gv-container">
                    <asp:GridView ID="gvServicios" CssClass="auto-style10" runat="server" AutoGenerateDeleteButton="True" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="725px" AllowPaging="True" AutoGenerateEditButton="True" ShowFooter="True">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:TemplateField HeaderText="Nombre">
                                <ItemTemplate>
